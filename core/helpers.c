...
void load_images(Images* imgs) {
    ...
    imgs->challenges[3] = al_load_bitmap("images/challenge-4.png");
    ...
    imgs->char_sprites.front[0] = al_load_bitmap("images/standing-front.png");
    must_init(imgs->char_sprites.front[0], "char front image");
    imgs->char_sprites.front[1] = al_load_bitmap("images/walking-front-1.png");
    must_init(imgs->char_sprites.front[1], "char walking 1 front image");
    imgs->char_sprites.front[2] = al_load_bitmap("images/walking-front-2.png");
    must_init(imgs->char_sprites.front[2], "char walking 2 front image");
    imgs->char_sprites.back[0] = al_load_bitmap("images/standing-back.png");
    must_init(imgs->char_sprites.back[0], "char back image");
    imgs->char_sprites.back[1] = al_load_bitmap("images/walking-back-1.png");
    must_init(imgs->char_sprites.back[1], "char walking 1 back image");
    imgs->char_sprites.back[2] = al_load_bitmap("images/walking-back-2.png");
    must_init(imgs->char_sprites.back[2], "char walking 2 back image");
    imgs->char_sprites.left[0] = al_load_bitmap("images/standing-left.png");
    must_init(imgs->char_sprites.left[0], "char left image");
    imgs->char_sprites.left[1] = al_load_bitmap("images/walking-left-1.png");
    must_init(imgs->char_sprites.left[1], "char walking 1 left image");
    imgs->char_sprites.left[2] = al_load_bitmap("images/walking-left-2.png");
    must_init(imgs->char_sprites.left[2], "char walking 2 left image");
    imgs->char_sprites.right[0] = al_load_bitmap("images/standing-right.png");
    must_init(imgs->char_sprites.right[0], "char right image");
    imgs->char_sprites.right[1] = al_load_bitmap("images/walking-right-1.png");
    must_init(imgs->char_sprites.right[1], "char walking 1 right image");
    imgs->char_sprites.right[2] = al_load_bitmap("images/walking-right-2.png");
    ...
    imgs->c5_selectable_objects[0] = al_load_bitmap("images/dry-leaves.png");
    must_init(imgs->c5_selectable_objects[0], "c5 selectable object 1 image");
    imgs->c5_selectable_objects[1] = al_load_bitmap("images/dry-wood-sticks.png");
    must_init(imgs->c5_selectable_objects[1], "c5 selectable object 2 image");
    imgs->c5_selectable_objects[2] = al_load_bitmap("images/wet-wood-sticks.png");
    must_init(imgs->c5_selectable_objects[2], "c5 selectable object 3 image");
    imgs->c5_selectable_objects[3] = al_load_bitmap("images/leaves.png");
    must_init(imgs->c5_selectable_objects[3], "c5 selectable object 4 image");
    imgs->c5_selectable_objects[4] = al_load_bitmap("images/sand.png");
    must_init(imgs->c5_selectable_objects[4], "c5 selectable object 5 image");
    imgs->c5_selectable_objects[5] = al_load_bitmap("images/shell.png");
    must_init(imgs->c5_selectable_objects[5], "c5 selectable object 6 image");
    imgs->c5_selectable_objects[6] = al_load_bitmap("images/seaweed.png");
    must_init(imgs->c5_selectable_objects[6], "c5 selectable object 7 image");
    imgs->c5_selectable_objects[7] = al_load_bitmap("images/rotten-fruits.png");
...
void load_videos(Videos* videos) {
    ...
    videos->tutorials[9] = al_open_video("videos/challenge-4-out-p1.ogv");
    ...
    videos->tutorials[11] = al_open_video("videos/challenge-4-out-p2.ogv");
    ...
    videos->tutorials[13] = al_open_video("videos/challenge-4-out-p3.ogv");
    ...
    videos->tutorials[15] = al_open_video("videos/challenge-5-out.ogv");
